...
public class AsyncTaskActivity extends Activity {
    ...
    public static final String TAG = AsyncTaskActivity.class.getCanonicalName();
    public static final String TITLE = "AsyncTaskActivity";
    public static final String ACTION_NAME = "com.bingo.demo.asyncTaskActivity_action";
...
//                mTask = new MyTask();
                mTask = new TestAsyncTask(AsyncTaskActivity.this, textView, progressBar );
    ...
    class TestAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        public TestAsyncTask(AsyncTaskActivity activity, TextView textView, ProgressBar bar ) {
